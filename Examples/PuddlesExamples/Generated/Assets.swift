...
internal enum Asset {
  ...
  internal static let bubblegum = ColorAsset(name: "bubblegum")
  internal static let buttercup = ColorAsset(name: "buttercup")
  ...
  internal static let oxblood = ColorAsset(name: "oxblood")
  internal static let periwinkle = ColorAsset(name: "periwinkle")
  internal static let poppy = ColorAsset(name: "poppy")
  internal static let purple = ColorAsset(name: "purple")
  internal static let seafoam = ColorAsset(name: "seafoam")
  internal static let sky = ColorAsset(name: "sky")
...
internal final class ColorAsset {
  ...
  internal func uiColor(compatibleWith traitCollection: UITraitCollection) -> Color {
